      ...
      <div className="container mx-auto p-6 space-y-6">
        <div className="flex items-center gap-4 animate-slide-in-up">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Modificar formulario pre-hospitalario #{formData.numeroFormulario}</p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {formData.medicamentosInsumos.map((medicamento, index) => (
                <div key={medicamento.id} className="border rounded-lg p-4 space-y-4 bg-muted/20">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div className="space-y-2">
                      <Label htmlFor={`medicamento-${medicamento.id}`}>Nombre del Medicamento</Label>
                      <Input
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <Label>Firma del Médico/Paramédico</Label>
                  <SignatureField
                    onSignatureChange={(signature) => updateFormData("firmaMedico", signature)}
                    placeholder="Firma del médico o paramédico responsable"
                    initialSignature={formData.firmaMedico}
                  />
                  <div className="space-y-2">
                ...
                <div className="space-y-4">
                  <Label>Firma del Paciente/Responsable</Label>
                  <SignatureField
                    onSignatureChange={(signature) => updateFormData("firmaPaciente", signature)}
                    placeholder="Firma del paciente o responsable legal"
                    initialSignature={formData.firmaPaciente}
                  />
                  <div className="space-y-2">
          ...
          <div className="flex justify-end gap-4">
            <Link href="/aph-digital">
              <Button variant="outline" type="button" className="medical-button-secondary bg-transparent">
                Cancelar
              </Button>
            </Link>
