    ...
    return (
      <div className="min-h-screen medical-bg-gradient flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-4">El formulario solicitado no existe o ha sido eliminado.</p>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Vista detallada del formulario pre-hospitalario</p>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-6">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="space-y-2">
                  <label className="text-sm font-medium text-muted-foreground">Número de Formulario</label>
          ...
          <Card className="medical-section animate-fade-in">
            ...
            <CardContent>
              <div className="flex gap-2 flex-wrap">
                {formData.ambulanciaBasica && <Badge className="medical-badge">Ambulancia Básica</Badge>}
                {formData.medicalizado && <Badge className="medical-badge">Medicalizado</Badge>}
                {formData.consultaMedica && <Badge className="medical-badge">Consulta Médica</Badge>}
                {!formData.ambulanciaBasica && !formData.medicalizado && !formData.consultaMedica && (
                  <p className="text-muted-foreground">No se ha especificado el tipo de servicio</p>
                )}
              </div>
            </CardContent>
          </Card>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {!formData.estadoPaciente && (
                      <p className="text-lg font-semibold text-muted-foreground">No especificado</p>
                    )}
                  </div>
                </div>
              </div>
          ...
          <Card className="medical-section animate-fade-in">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-muted-foreground">Nota de Evolución</label>
                <div className="bg-muted/20 p-4 rounded-lg">
                  <p className="whitespace-pre-wrap">{formData.notaEvolucion || "No especificada"}</p>
                </div>
              </div>
              <div className="space-y-2">
                <label className="text-sm font-medium text-muted-foreground">Procedimientos Realizados</label>
                <div className="bg-muted/20 p-4 rounded-lg">
          ...
          <Card className="medical-section animate-fade-in">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="space-y-2">
                  <label className="text-sm font-medium text-muted-foreground">FC (Frecuencia Cardíaca)</label>
                  <p className="text-lg font-semibold">{formData.fc || "No registrada"}</p>
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-medium text-muted-foreground">FR (Frecuencia Respiratoria)</label>
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-muted-foreground">TA (Tensión Arterial)</label>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-muted-foreground">Escala de Glasgow</label>
          ...
          <Card className="medical-section animate-fade-in">
            <CardHeader>
              ...
              <CardDescription>Registro de medicamentos administrados e insumos utilizados</CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  {formData.medicamentosInsumos.map((medicamento, index) => (
                    <div key={medicamento.id} className="border rounded-lg p-4 bg-muted/20">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div className="space-y-2">
                          <label className="text-sm font-medium text-muted-foreground">Vía</label>
          ...
          <Card className="medical-section animate-fade-in">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <label className="text-sm font-medium text-muted-foreground">Orden del servicio No.</label>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <label className="text-sm font-medium text-muted-foreground">Lugar de Ocurrencia</label>
                  <p className="text-lg font-semibold">{formData.lugarOcurrencia || "No especificado"}</p>
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-medium text-muted-foreground">Destino Final</label>
          ...
          <Card className="medical-section animate-fade-in">
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <label className="text-sm font-medium text-muted-foreground">Firma del Médico/Paramédico</label>
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-muted-foreground">Nombre del Médico/Paramédico</label>
                    <p className="font-semibold">{formData.nombreMedico || "No especificado"}</p>
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-muted-foreground">Registro Profesional</label>
                    <p className="font-semibold">{formData.registroMedico || "No especificado"}</p>
                  </div>
                </div>

                <div className="space-y-4">
                  <label className="text-sm font-medium text-muted-foreground">Firma del Paciente/Responsable</label>
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-muted-foreground">Nombre del Responsable</label>
